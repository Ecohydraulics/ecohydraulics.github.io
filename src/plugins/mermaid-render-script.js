(() => {
    ...
    // Set up a MutationObserver to watch the class attribute of the html element
        ...
        const observer = new MutationObserver((mutations) => {
            mutations.forEach((mutation) => {
                if (
                    ...
                    // Check whether it is a change to the dark class
    ...
    function setupEventListeners() {
        ...
        // Listen for visibility changes and re-render when the page becomes visible again
    ...
    async function renderMermaidDiagrams() {
        ...
        try {
            ...
            // Batch-render all diagrams with a retry mechanism
                    ...
                    while (attempts < maxAttempts) {
                        try {
                            ...
                            if (insertedSvg) {
                                ...
                                //Todo: depends on the actual situation
