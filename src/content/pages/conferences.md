---
title: "Conferences"
description: "The International Symposium on Ecohydraulics (ISE) and related events."
---

## International Symposium on Ecohydraulics (ISE)

Launched in 1994, the International Symposia on Ecohydraulics aim to provide a platform for scientists and engineers worldwide to discuss cutting-edge scientific progress, compare and evaluate state-of-the-art technical methods, and recommend them to end users. A complete list of past ISE conferences is provided on the [IAHR website](https://www.iahr.org/index/committe/10). Aspiring future Local Organizing Committees (LOCs) should keep an eye on the [IAHR news stream](https://www.iahr.org/index/news). Calls for Letters of Intent from aspiring LOCs are typically announced 5-7 months before the next ISE.

### ISE 2028: Host to Be Announced

The 17th International Symposium on Ecohydraulics is scheduled for 2028, but the host has not yet been announced. The IAHR Ecohydraulics Technical Committee Leadership Team invited Letters of Intent from the global community to serve as the Local Organizing Committee; that call closed on **31 March 2025** and the Leadership Team is evaluating the proposals received. Letters of intent are reviewed against three criteria: (1) preference for proposals from continents that have not hosted an ISE in recent years; (2) quality of the scientific concept; and (3) likelihood of successful organization and contribution to advancing the goals of the ecohydraulics community. The ISE typically runs from Sunday to Friday, with workshops and meetings on Sunday, sessions Monday through Friday, and a field trip on Wednesday. Questions can be directed to the TC Chair and Vice Chair, Prof. Michele Mossa and Prof. Daniele Tonina. Watch the
[IAHR news stream](https://www.iahr.org/index/news) for the host announcement.
