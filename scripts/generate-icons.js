/**
 * Icon preprocessing script (Twilight edition)
 * Scans the icons used in Svelte and Astro components at build time and generates inline SVG data
 * 
 * Logic:
 * 1. Scan .svelte and .astro files under the src directory
 * 2. Extract all icons of the form icon="prefix:name"
...
function loadIconSet(prefix) {
    ...
    try {
        ...
        console.warn(`⚠️  Failed to load icon set ${packageName}: ${error.message}`);
        return null;
    }
}

/**
 * Get the SVG of a single icon
 */
function getIconSvg(iconName) {
    ...
    if (!iconData) {
        // Try to look it up among the aliases
